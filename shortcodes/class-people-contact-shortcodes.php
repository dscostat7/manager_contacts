...
class Shortcode{
	...
	public function add_people_contact_button() {
        ...
        if(!$is_post_edit_page)
            return;
		echo '<a href="#TB_inline?width=640&height=580&inlineId=people-contact-wrap" class="thickbox button contact_add_shortcode" title="' . __( 'Insert shortcode', 'manager-contacts-page-contact-people' ) . '"><span class="contact_add_shortcode_icon"></span>'.__('Contact', 'manager-contacts-page-contact-people' ).'</a>';
		?>
        <style type="text/css">
	...
	public function people_contact_generator_popup() {
		...
		<div id="people-contact-wrap" style="display:none">
        	<fieldset style="border:1px solid #DFDFDF; padding:0 20px; background: #FFF; margin-top:15px;"><legend style="font-weight:bold; font-size:14px;"><?php _e('Insert Single Profile', 'manager-contacts-page-contact-people' ); ?></legend>
            <div id="people-contact-content" class="people-contact-content people-contact-shortcode-container" style="text-align:left;">
                <p><label for="people_contact_item"><?php _e('Select Profile', 'manager-contacts-page-contact-people' ); ?>:</label> 
                    <select style="width:300px" id="people_contact_item" name="people_contact_item">
                    <?php
                        echo '<option value="">'.__('Please select...', 'manager-contacts-page-contact-people' ).'</option>';	
                ...
                <p><label for="people_contact_align"><?php _e('Card Alignment', 'manager-contacts-page-contact-people' ); ?>:</label> <select style="width:120px" id="people_contact_align" name="people_contact_align"><option value="none" selected="selected"><?php _e('None', 'manager-contacts-page-contact-people' ); ?></option><option value="left-wrap"><?php _e('Left - wrap', 'manager-contacts-page-contact-people' ); ?></option><option value="left"><?php _e('Left - no wrap', 'manager-contacts-page-contact-people' ); ?></option><option value="center"><?php _e('Center', 'manager-contacts-page-contact-people' ); ?></option><option value="right-wrap"><?php _e('Right - wrap', 'manager-contacts-page-contact-people' ); ?></option><option value="right"><?php _e('Right - no wrap', 'manager-contacts-page-contact-people' ); ?></option></select> <span class="description"><?php _e('Wrap is text wrap like images', 'manager-contacts-page-contact-people' ); ?></span></p>
				<p><label for="people_contact_item_width"><?php _e('Card Width', 'manager-contacts-page-contact-people' ); ?>:</label> <input style="width:50px;" size="10" id="people_contact_item_width" name="people_contact_item_width" type="text" value="300" />px</p>
				<p><label for=""><strong><?php _e('Card External Padding', 'manager-contacts-page-contact-people' ); ?></strong>:</label><br /> 
                        <label for="people_contact_padding_top" style="width:auto; float:none"><?php _e('Above', 'manager-contacts-page-contact-people' ); ?>:</label><input style="width:50px;" size="10" id="people_contact_padding_top" name="people_contact_padding_top" type="text" value="10" />px &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <label for="people_contact_padding_bottom" style="width:auto; float:none"><?php _e('Below', 'manager-contacts-page-contact-people' ); ?>:</label> <input style="width:50px;" size="10" id="people_contact_padding_bottom" name="people_contact_padding_bottom" type="text" value="10" />px &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <label for="people_contact_padding_left" style="width:auto; float:none"><?php _e('Left', 'manager-contacts-page-contact-people' ); ?>:</label> <input style="width:50px;" size="10" id="people_contact_padding_left" name="people_contact_padding_left" type="text" value="0" />px &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <label for="people_contact_padding_right" style="width:auto; float:none"><?php _e('Right', 'manager-contacts-page-contact-people' ); ?>:</label> <input style="width:50px;" size="10" id="people_contact_padding_right" name="people_contact_padding_right" type="text" value="0" />px
                </p>
			</div>
            <div style="clear:both;height:0px"></div>
            <p><input type="button" class="button button-primary" value="<?php _e('Insert Shortcode', 'manager-contacts-page-contact-people' ); ?>" onclick="people_contact_add_shortcode();"/> 
            <input type="button" class="button" onclick="tb_remove(); return false;" value="<?php _e('Cancel', 'manager-contacts-page-contact-people' ); ?>" />
			</p>
            </fieldset>
            ...
            <fieldset style="border:1px solid #DFDFDF; padding:0 20px; background: #FFF; margin:10px;"><legend style="font-weight:bold; font-size:14px;"><?php _e('Insert Group', 'manager-contacts-page-contact-people' ); ?></legend>
            <div id="people-category-content" class="people-category-content people-contact-shortcode-container" style="text-align:left;">
                <p><label for="profile_category_id"><?php _e('Select Group', 'manager-contacts-page-contact-people' ); ?>:</label> 
                ...
                <p><label for="profile_category_column"><?php _e('Profile Cards / Row', 'manager-contacts-page-contact-people' ); ?>:</label> 
                	<select style="width:120px" id="profile_category_column" name="profile_category_column">
                    <?php
					echo '<option value="">'.__('Please select...', 'manager-contacts-page-contact-people' ).'</option>';
						echo '<option value="1">1 ' .__('Card', 'manager-contacts-page-contact-people' ) .' </option>';
					for ( $column = 2; $column <= 5; $column++ ) {
						echo '<option value="'.$column.'">'. $column. ' ' .__('Cards', 'manager-contacts-page-contact-people' ) .' </option>';
					}
                    ?>
                    </select> <span class="description"><?php _e('Empty to use global settings.', 'manager-contacts-page-contact-people' ); ?></span>
				</p>
                <p><label for="enable_google_map"><?php _e('Google Map', 'manager-contacts-page-contact-people' ); ?>:</label> <input disabled="disabled" type="checkbox" id="enable_google_map" name="enable_google_map" value="1" <?php if ( $people_contact_location_map_settings['hide_maps_frontend'] != 1 ) echo 'checked="checked"'; ?> /> <span><?php _e('Check to enable google location map for this group.', 'manager-contacts-page-contact-people' ); ?></span>
                </p>
                <p><label for="people_show_group_title"><?php _e('Group Title', 'manager-contacts-page-contact-people' ); ?>:</label> <input disabled="disabled" type="checkbox" id="people_show_group_title" name="people_show_group_title" value="1" checked="checked" /> <span><?php _e('Check to show group title above Profiles.', 'manager-contacts-page-contact-people' ); ?></span>
                </p>
				
			</div>
            <div style="clear:both;height:0px"></div>
            <p><input disabled="disabled" type="button" class="button button-primary" value="<?php _e('Insert Shortcode', 'manager-contacts-page-contact-people' ); ?>" /> 
            <input type="button" class="button" onclick="tb_remove(); return false;" value="<?php _e('Cancel', 'manager-contacts-page-contact-people' ); ?>" />
			</p>
            </fieldset>
		</div></div>
		...
		function people_contact_add_shortcode(){
			...
			if (select_people == '') {
				alert('<?php _e('Please select People', 'manager-contacts-page-contact-people' ); ?>');
				return false;	
			}
