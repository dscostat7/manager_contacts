...
{	
	...
	public static function contact_to_people( $profile_data = array(), $send_copy_yourself = 1 ) {
		...
		else $contact_success = __("Thanks for your contact - we'll be in touch with you as soon as possible!", 'manager-contacts-page-contact-people' );
		...
		$subject_yourself = people_ict_t__( 'Email Inquiry - Copy', __('[Copy]:', 'manager-contacts-page-contact-people' ) ).' '. stripslashes( $profile_data['subject'] );

		$from_page_html = '';
		if ( $include_from_page ) {
			$from_page_html = '
			<tr bgcolor="#eaf2fa">
			  <td colspan="2"><font style="FONT-FAMILY:sans-serif;FONT-SIZE:12px"><strong>'. people_ict_t__( 'Email Inquiry - From Page Title', __('From Page Title', 'manager-contacts-page-contact-people' ) ) .'</strong></font> 
			  </td></tr>
			<tr bgcolor="#ffffff">
			  <td width="20">&nbsp;</td>
			  <td><font style="FONT-FAMILY:sans-serif;FONT-SIZE:12px">' . esc_html( $from_page_title ) . '</font> </td></tr>
			<tr bgcolor="#eaf2fa">
			  <td colspan="2"><font style="FONT-FAMILY:sans-serif;FONT-SIZE:12px"><strong>'. people_ict_t__( 'Email Inquiry - From Page URL', __('From Page URL', 'manager-contacts-page-contact-people' ) ) .'</strong></font> 
			  </td></tr>
			<tr bgcolor="#ffffff">
			  <td width="20">&nbsp;</td>
	  ...
	  <tr>
		<td>
		  <table width="100%" cellspacing="0" cellpadding="5" border="0" bgcolor="#ffffff"><tbody>
			<tr bgcolor="#eaf2fa">
			  <td colspan="2"><font style="FONT-FAMILY:sans-serif;FONT-SIZE:12px"><strong>'. people_ict_t__( 'Email Inquiry - Profile Name', __('Profile Name', 'manager-contacts-page-contact-people' ) ) .'</strong></font> 
			  </td></tr>
			<tr bgcolor="#ffffff">
			  <td width="20">&nbsp;</td>
			...
			'.$from_page_html.'
			<tr bgcolor="#eaf2fa">
			  <td colspan="2"><font style="FONT-FAMILY:sans-serif;FONT-SIZE:12px"><strong>'. people_ict_t__( 'Email Inquiry - Contact Name', __('Contact Name', 'manager-contacts-page-contact-people' ) ) .'</strong></font> 
			  </td></tr>
			<tr bgcolor="#ffffff">
			  <td width="20">&nbsp;</td>
			  <td><font style="FONT-FAMILY:sans-serif;FONT-SIZE:12px">[contact_name]</font> </td></tr>
			<tr bgcolor="#eaf2fa">
			  <td colspan="2"><font style="FONT-FAMILY:sans-serif;FONT-SIZE:12px"><strong>'. people_ict_t__( 'Email Inquiry - Contact Email', __('Contact Email Address', 'manager-contacts-page-contact-people' ) ) .'</strong></font> </td></tr>
			<tr bgcolor="#ffffff">
			  <td width="20">&nbsp;</td>
			  <td><font style="FONT-FAMILY:sans-serif;FONT-SIZE:12px"><a target="_blank" href="mailto:[contact_email]">[contact_email]</a></font> 
			  </td></tr>
			<tr bgcolor="#eaf2fa">
			  <td colspan="2"><font style="FONT-FAMILY:sans-serif;FONT-SIZE:12px"><strong>'. people_ict_t__( 'Email Inquiry - Contact Phone', __('Contact Phone', 'manager-contacts-page-contact-people' ) ) .'</strong></font> </td></tr>
			<tr bgcolor="#ffffff">
			  <td width="20">&nbsp;</td>
			  <td><font style="FONT-FAMILY:sans-serif;FONT-SIZE:12px">[contact_phone]</font> </td></tr>
			<tr bgcolor="#eaf2fa">
			  <td colspan="2"><font style="FONT-FAMILY:sans-serif;FONT-SIZE:12px"><strong>'. people_ict_t__( 'Email Inquiry - Contact Message', __('Message', 'manager-contacts-page-contact-people' ) ) .'</strong></font> </td></tr>
			<tr bgcolor="#ffffff">
			  <td width="20">&nbsp;</td>
	...
	public static function contact_to_site( $contact_data = array(), $send_copy_yourself = 1 ) {
		...
		$contact_success = people_ict_t__( 'Contact Widget - Success Message', __("Thanks for your contact - we'll be in touch with you as soon as possible!", 'manager-contacts-page-contact-people' ) );
		...
		if ( $people_contact_widget_email_contact_form['widget_email_from_address'] == '' )
			...
			$subject_yourself = people_ict_t__( 'Contact Widget - Copy', __('[Copy]:', 'manager-contacts-page-contact-people' ) ).' '. stripslashes( $contact_data['subject']) ;
	...
	<table width="99%" cellspacing="0" cellpadding="1" border="0" bgcolor="#eaeaea"><tbody>
	  <tr>
		<td>
		  <table width="100%" cellspacing="0" cellpadding="5" border="0" bgcolor="#ffffff"><tbody>
			<tr bgcolor="#eaf2fa">
			  <td colspan="2"><font style="FONT-FAMILY:sans-serif;FONT-SIZE:12px"><strong>'.people_ict_t__( 'Contact Widget - Name', __('Name', 'manager-contacts-page-contact-people' ) ).'</strong></font> 
			  </td></tr>
			<tr bgcolor="#ffffff">
			  <td width="20">&nbsp;</td>
			  <td><font style="FONT-FAMILY:sans-serif;FONT-SIZE:12px">[contact_name]</font> </td></tr>
			<tr bgcolor="#eaf2fa">
			  <td colspan="2"><font style="FONT-FAMILY:sans-serif;FONT-SIZE:12px"><strong>'.people_ict_t__( 'Contact Widget - Email Address', __('Email Address', 'manager-contacts-page-contact-people' ) ).'</strong></font> </td></tr>
			<tr bgcolor="#ffffff">
			  <td width="20">&nbsp;</td>
			  <td><font style="FONT-FAMILY:sans-serif;FONT-SIZE:12px"><a target="_blank" href="mailto:[contact_email]">[contact_email]</a></font> 
			  </td></tr>
			<tr bgcolor="#eaf2fa">
			  <td colspan="2"><font style="FONT-FAMILY:sans-serif;FONT-SIZE:12px"><strong>'.people_ict_t__( 'Contact Widget - Message', __('Message', 'manager-contacts-page-contact-people' ) ).'</strong></font> </td></tr>
			<tr bgcolor="#ffffff">
			  <td width="20">&nbsp;</td>
			  <td><font style="FONT-FAMILY:sans-serif;FONT-SIZE:12px">[message]</font> 
		  </td></tr></tbody></table></td></tr></tbody></table>';
	...
	public static function modal_popup_container( $profile_email_form = '' ) {
		...
		if ( empty( $inquiry_contact_heading ) ) {
			$inquiry_contact_heading = __( 'Email Inquiry', 'manager-contacts-page-contact-people' );
		}
	...
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<span class="close" data-dismiss="modal" aria-label="<?php echo __( 'Close', 'manager-contacts-page-contact-people' ); ?>">
	...
	public static function people_contact_register_sidebar() {
		...
		register_sidebar(array(
		  ...
		  'id' => 'manager-contacts-sidebar',
		  'description' => __( 'Contact Page Widgets area.', 'manager-contacts-page-contact-people' ),
	...
	public static function extension_shortcode() {
		$html = '';
		$html .= '<div id="a3_plugin_shortcode_extensions">'. sprintf( __( '<a href="%s" target="_blank">Ultimate Version</a> only', 'manager-contacts-page-contact-people' ), PEOPLE_CONTACT_ULTIMATE_URI ) .'</div>';
		return $html;	
	}
}
