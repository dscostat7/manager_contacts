...
{	
	...
	public function wpml_register_dynamic_string() {
		...
		if ( function_exists('icl_register_string') ) {
			...
			icl_register_string($this->plugin_wpml_name, 'Manager Contacts Widget - Address', $people_contact_widget_information['widget_info_address'] );

			$people_contact_widget_content_before_maps = stripslashes( get_option( 'people_contact_widget_content_before_maps', '' ) );
			icl_register_string($this->plugin_wpml_name, 'Manager Contacts Widget - Content Before Map', $people_contact_widget_content_before_maps );

			$people_contact_widget_content_after_maps = stripslashes( get_option( 'people_contact_widget_content_after_maps', '' ) );
			icl_register_string($this->plugin_wpml_name, 'Manager Contacts Widget - Content After Map', $people_contact_widget_content_after_maps );
			...
			icl_register_string($this->plugin_wpml_name, 'Manager Contacts Widget - From Name', $people_contact_widget_email_contact_form['widget_email_from_name'] );
			...
			icl_register_string($this->plugin_wpml_name, 'Manager Contacts Widget - Map Callout Text', $people_contact_widget_maps['widget_maps_callout_text'] );
	...
	public function wpml_register_static_string() {
		if ( function_exists('icl_register_string') ) {
			...
			// Default Form
			icl_register_string($this->plugin_wpml_name, 'Default Form - Contact Name', __( 'Name', 'manager-contacts-page-contact-people' ) );
			icl_register_string($this->plugin_wpml_name, 'Default Form - Contact Email', __( 'Email', 'manager-contacts-page-contact-people' ) );
			icl_register_string($this->plugin_wpml_name, 'Default Form - Contact Phone', __( 'Phone', 'manager-contacts-page-contact-people' ) );
			icl_register_string($this->plugin_wpml_name, 'Default Form - Contact Subject', __( 'Subject', 'manager-contacts-page-contact-people' ) );
			icl_register_string($this->plugin_wpml_name, 'Default Form - Contact Message', __( 'Message', 'manager-contacts-page-contact-people' ) );
			icl_register_string($this->plugin_wpml_name, 'Default Form - Send Copy', __( 'Send a copy of this email to myself.', 'manager-contacts-page-contact-people' ) );

			icl_register_string($this->plugin_wpml_name, 'Default Form - Contact Email Error', __( 'Please enter valid Email addres',  'manager-contacts-page-contact-people' ) );
			icl_register_string($this->plugin_wpml_name, 'Default Form - Required Error', __( 'is required',  'manager-contacts-page-contact-people' ) );
			icl_register_string($this->plugin_wpml_name, 'Default Form - Agree Terms Error', __( 'You need to agree to the website terms and conditions if want to submit this inquiry', 'manager-contacts-page-contact-people' ) );
			icl_register_string($this->plugin_wpml_name, 'Default Form - Contact Not Allow', __( "Sorry, you can't contact at this time.", 'manager-contacts-page-contact-people' ) );
			
			icl_register_string($this->plugin_wpml_name, 'Email Inquiry - from', __( 'from', 'manager-contacts-page-contact-people' ) );
			icl_register_string($this->plugin_wpml_name, 'Email Inquiry - Contact from', __( 'Contact from', 'manager-contacts-page-contact-people' ) );
			
			icl_register_string($this->plugin_wpml_name, 'Email Inquiry - Profile Name', __( 'Profile Name', 'manager-contacts-page-contact-people' ) );
			icl_register_string($this->plugin_wpml_name, 'Email Inquiry - From Page Title', __( 'From Page Title', 'manager-contacts-page-contact-people' ) );
			icl_register_string($this->plugin_wpml_name, 'Email Inquiry - From Page URL', __( 'From Page URL', 'manager-contacts-page-contact-people' ) );
			icl_register_string($this->plugin_wpml_name, 'Email Inquiry - Contact Name', __( 'Contact Name', 'manager-contacts-page-contact-people' ) );
			icl_register_string($this->plugin_wpml_name, 'Email Inquiry - Contact Email', __( 'Contact Email Address', 'manager-contacts-page-contact-people' ) );
			icl_register_string($this->plugin_wpml_name, 'Email Inquiry - Contact Phone', __( 'Contact Phone', 'manager-contacts-page-contact-people' ) );
			icl_register_string($this->plugin_wpml_name, 'Email Inquiry - Contact Message', __( 'Message', 'manager-contacts-page-contact-people' ) );
			
			icl_register_string($this->plugin_wpml_name, 'Email Inquiry - Copy', __( '[Copy]:', 'manager-contacts-page-contact-people' ) );
			
			icl_register_string($this->plugin_wpml_name, 'Contact Widget - Success Message', __( "Thanks for your contact - we'll be in touch with you as soon as possible!", 'manager-contacts-page-contact-people' ) );
			icl_register_string($this->plugin_wpml_name, 'Contact Widget - Copy', __( '[Copy]:', 'manager-contacts-page-contact-people' ) );
			icl_register_string($this->plugin_wpml_name, 'Contact Widget - Name', __( 'Name', 'manager-contacts-page-contact-people' ) );
			icl_register_string($this->plugin_wpml_name, 'Contact Widget - Email Address', __( 'Email Address', 'manager-contacts-page-contact-people' ) );
			icl_register_string($this->plugin_wpml_name, 'Contact Widget - Message', __( 'Message', 'manager-contacts-page-contact-people' ) );
	...
	public function ict_t_contact_widget_settings( $current_settings = array() ) {
		if ( is_array( $current_settings ) && isset( $current_settings['widget_info_address'] ) ) 
			$current_settings['widget_info_address'] = ( function_exists('icl_t') ? icl_t( $this->plugin_wpml_name, 'Manager Contacts Widget - Address', $current_settings['widget_info_address'] ) : $current_settings['widget_info_address'] );
		if ( is_array( $current_settings ) && isset( $current_settings['widget_email_from_name'] ) ) 
			$current_settings['widget_email_from_name'] = ( function_exists('icl_t') ? icl_t( $this->plugin_wpml_name, 'Manager Contacts Widget - From Name', $current_settings['widget_email_from_name'] ) : $current_settings['widget_email_from_name'] );
		if ( is_array( $current_settings ) && isset( $current_settings['widget_maps_callout_text'] ) ) 
			$current_settings['widget_maps_callout_text'] = ( function_exists('icl_t') ? icl_t( $this->plugin_wpml_name, 'Manager Contacts Widget - Map Callout Text', $current_settings['widget_maps_callout_text'] ) : $current_settings['widget_maps_callout_text'] );
		if ( is_array( $current_settings ) && isset( $current_settings['people_contact_widget_content_before_maps'] ) ) 
			$current_settings['people_contact_widget_content_before_maps'] = ( function_exists('icl_t') ? icl_t( $this->plugin_wpml_name, 'Manager Contacts Widget - Content Before Map', $current_settings['people_contact_widget_content_before_maps'] ) : $current_settings['people_contact_widget_content_before_maps'] );
		if ( is_array( $current_settings ) && isset( $current_settings['people_contact_widget_content_after_maps'] ) ) 
			$current_settings['people_contact_widget_content_after_maps'] = ( function_exists('icl_t') ? icl_t( $this->plugin_wpml_name, 'Manager Contacts Widget - Content After Map', $current_settings['people_contact_widget_content_after_maps'] ) : $current_settings['people_contact_widget_content_after_maps'] );
