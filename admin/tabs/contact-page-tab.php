...
class Contact_Page extends FrameWork\Admin_UI
{	
	/**
	 * @var string
	 */
	...
	public function tab_data() {
		...
		$tab_data = array( 
			'name'				=> 'contact-page',
			'label'				=> __( 'Manager Contacts Page', 'manager-contacts-page-contact-people' ),
	...
	public function settings_include() {
		...
		$contact_page_global_settings = new FrameWork\Settings\Global_Panel();
