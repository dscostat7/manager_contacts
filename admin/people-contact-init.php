...
function people_contact_install(){
	...
	$contact_us_page_id = \A3Rev\ContactPeople\Contact_Functions::create_page( esc_sql( 'manager-contacts-page' ), 'contact_us_page_id', __('Manager Contacts Page', 'manager-contacts-page-contact-people' ), '[people_contacts]' );
	\A3Rev\ContactPeople\Contact_Functions::auto_create_page_for_wpml( $contact_us_page_id, _x('manager-contacts-page', 'page_slug', 'manager-contacts-page-contact-people' ), __('Manager Contacts Page', 'manager-contacts-page-contact-people' ), '[people_contacts]' );
