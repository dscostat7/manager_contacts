...
class Contact_Widget extends FrameWork\Admin_UI
{
	...
	public function __construct() {
		...
		$this->form_messages = array(
				'success_message'	=> __( 'Contact Widget Settings successfully saved.', 'manager-contacts-page-contact-people' ),
				'error_message'		=> __( 'Error: Contact Widget Settings can not save.', 'manager-contacts-page-contact-people' ),
				'reset_message'		=> __( 'Contact Widget Settings successfully reseted.', 'manager-contacts-page-contact-people' ),
			);
	...
	public function init_form_fields() {
		...
		$privacy_policy_url = '#';
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(
            	'name' 		=> __( 'Help Notes', 'manager-contacts-page-contact-people' ),
                'type' 		=> 'heading',
                'id'		=> 'contact_widget_help_notes_box',
                'is_box'	=> true,
           	),
			array(
            	'name' 		=> __( 'Manager Contacts Widget', 'manager-contacts-page-contact-people' ),
				'desc'		=> sprintf( __( 'This plugin includes a <a href="%s" target="_blank">Manager Contacts Widget</a>. Use it to add Business / Organization Details, information and a general Manager Contacts form to the Manager Contacts Page sidebar. All of the Widget settings are here on the Contact Widget tab. Use the plugins built in Contact Form or add a custom form by shortcode from a Contact Form plugin of your choice.', 'manager-contacts-page-contact-people' ), admin_url('widgets.php') ),
                'type' 		=> 'heading',
           	),
			array(
            	'name' 		=> __( 'Contact Page Sidebar', 'manager-contacts-page-contact-people' ),
				'desc'		=> sprintf( __( 'We recommend that you create a new sidebar and assign it to the Manager Contacts Page. If you do you can then add the Contact Widget to that sidebar and it will only show on the Manager Contacts page. We recommend you install this plugin <a href="%s" target="_blank">WooSidebars</a> and use it to create the custom sidebar.', 'manager-contacts-page-contact-people' ), 'http://wordpress.org/plugins/woosidebars/'),
                'type' 		=> 'heading',
           	),

           	array(
            	'name' 		=> __( 'Widget Contact Details', 'manager-contacts-page-contact-people' ),
				'desc'		=> __( "Add contact details to show in the widget, empty fields don't show on front end.", 'manager-contacts-page-contact-people' ),
                'type' 		=> 'heading',
                'id'		=> 'contact_widget_details_box',
                'is_box'	=> true,
           	),
			array(  
				'name' 		=> __( 'Address', 'manager-contacts-page-contact-people' ),
				'id' 		=> 'widget_info_address',
				'type' 		=> 'text',
				'default'	=> ''
			),
			array(  
				'name' 		=> __( 'Phone', 'manager-contacts-page-contact-people' ),
				'id' 		=> 'widget_info_phone',
				'type' 		=> 'text',
				'default'	=> ''
			),
			array(  
				'name' 		=> __( 'Fax', 'manager-contacts-page-contact-people' ),
				'id' 		=> 'widget_info_fax',
				'type' 		=> 'text',
				'default'	=> ''
			),
			array(  
				'name' 		=> __( 'Mobile', 'manager-contacts-page-contact-people' ),
				'id' 		=> 'widget_info_mobile',
				'type' 		=> 'text',
				'default'	=> ''
			),
			array(  
				'name' 		=> __( 'Visible Email address', 'manager-contacts-page-contact-people' ),
				'desc'		=> __( 'NOT Recommended! Open email addresses on a site allow spammers to scrape them. It is very bad form to have open email addresses anywhere on a site.', 'manager-contacts-page-contact-people' ),
			...
			array(
            	'name' 		=> __( 'Widget Custom Content', 'manager-contacts-page-contact-people' ),
                'type' 		=> 'heading',
                'id'		=> 'contact_widget_content_box',
                'is_box'	=> true,
           	),
			array(  
				'name' 		=> __( 'Content before Map', 'manager-contacts-page-contact-people' ),
				'desc'		=> __( "Content will show above map on widget. Leave empty and nothing shows on the frontend.", 'manager-contacts-page-contact-people' ),
			...
			array(  
				'name' 		=> __( 'Content after Map', 'manager-contacts-page-contact-people' ),
				'desc'		=> __( "Content will show below map on widget. Leave empty and nothing shows on the frontend.", 'manager-contacts-page-contact-people' ),
			...
			array(
            	'name' 		=> __( 'Widget Email Contact Form', 'manager-contacts-page-contact-people' ),
                'type' 		=> 'heading',
                'id'		=> 'email_contact_form_box',
                'is_box'	=> true,
           	),
           	array(  
				'name' 		=> __( 'Default Contact Form', 'manager-contacts-page-contact-people' ),
			...
			array(
				...
				'desc'		=> __( 'Create the widget Manager Contacts form by entering a shortcode from any contact form plugin.', 'manager-contacts-page-contact-people' ),
			...
			array(
            	'name' 		=> __( 'Email Delivery', 'manager-contacts-page-contact-people' ),
                'type' 		=> 'heading',
           	),
			array(  
				'name' 		=> __( 'Inquiry Email goes to', 'manager-contacts-page-contact-people' ),
				'desc' 		=> __( "Leave empty and your WordPress admin email address will be used", 'manager-contacts-page-contact-people' ),
			...
			array(  
				'name' 		=> __( 'CC', 'manager-contacts-page-contact-people' ),
				'desc' 		=> __( "Leave empty and no email is sent", 'manager-contacts-page-contact-people' ),
			...
			array(
            	'name' 		=> __( 'Widget Google Map', 'manager-contacts-page-contact-people' ),
                'type' 		=> 'heading',
                'id'		=> 'contact_widget_map_settings_box',
                'is_box'	=> true,
           	),
			array(  
				'name' 		=> __( 'Show Map', 'manager-contacts-page-contact-people' ),
			...
			array(  
				'name' 		=> __( 'Marker Location', 'manager-contacts-page-contact-people' ),
				'id' 		=> 'people_contact_widget_maps[widget_location]',
				'desc'		=> '</span><div style="font-size: 13px; margin-top: 10px;">'.__( '* Tip - drag and drop the map marker to the required location', 'manager-contacts-page-contact-people' ).'</div><div id="map_canvas"></div><span>',
			...
			array(  
				'name' 		=> __( 'Zoom Level', 'manager-contacts-page-contact-people' ),
			...
			array(  
				'name' 		=> __( 'Map Type', 'manager-contacts-page-contact-people' ),
			...
			array(  
				'name' 		=> __( 'Map Height', 'manager-contacts-page-contact-people' ),
				'desc'		=> 'px',
			...
			array(  
				'name' 		=> __( 'Map Callout Text', 'manager-contacts-page-contact-people' ),
				'desc' 		=> __( "Text or HTML that will be output when you click on the map marker for your location.", 'manager-contacts-page-contact-people' ),
