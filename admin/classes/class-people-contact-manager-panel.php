...
class Profile_Manager
{
	...
	public static function admin_screen () {
		...
		if( isset($_GET['action']) && $_GET['action'] == 'del' && isset($_GET['id']) && $_GET['id'] >= 0){
			...
			$message = '<div class="updated" id=""><p>'.__('Profile Successfully deleted.', 'manager-contacts-page-contact-people' ).'</p></div>';
		} elseif ( isset($_GET['edited_profile']) ) {
			$message = '<div class="updated" id=""><p>'.__('Profile Successfully updated.', 'manager-contacts-page-contact-people' ).'</p></div>';
		} elseif ( isset($_GET['created_profile']) ) {
			$message = '<div class="updated" id=""><p>'.__('Profile Successfully created.', 'manager-contacts-page-contact-people' ).'</p></div>';
		}
        ...
        <?php echo $message; ?>
        <div class="icon32 icon32-a3rev-ui-settings icon32-a3revpeople-contact-settings" id="icon32-a3revpeople-contact-manager"><br></div><h1><?php _e('Profiles', 'manager-contacts-page-contact-people' ); ?> <a class="add-new-h2" href="<?php echo admin_url('admin.php?page=people-contact', 'relative');?>"><?php _e('Add New', 'manager-contacts-page-contact-people' ); ?></a></h1>
		  ...
		  <table class="wp-list-table widefat fixed striped sorttable">
			<thead>
			  <tr>
				...
				<th width="25" class="manage-column column-number" style="text-align:right;white-space:nowrap"><?php _e('No', 'manager-contacts-page-contact-people' ); ?></th>
				<th width="40" class="manage-column column-image">&nbsp;</th>
				<th class="manage-column column-title" style="text-align:left;white-space:nowrap"><?php _e('Name', 'manager-contacts-page-contact-people' ); ?></th>
				<th width="10%" class="manage-column column-id" style="text-align:left;white-space:nowrap"><?php _e('ID', 'manager-contacts-page-contact-people' ); ?></th>
				<th width="18%" class="manage-column column-email" style="text-align:left;white-space:nowrap"><?php _e('Email', 'manager-contacts-page-contact-people' ); ?></th>
				<th width="8%" class="manage-column column-phone" style="text-align:left;white-space:nowrap"><?php _e('Phone', 'manager-contacts-page-contact-people' ); ?></th>
				<th width="15%" style="text-align:left" class="manage-column column-location"><?php _e('Location', 'manager-contacts-page-contact-people' ); ?></th>
			...
			<tfoot>
			  <tr>
				...
				<th class="manage-column column-number" style="text-align:right;white-space:nowrap"><?php _e('No', 'manager-contacts-page-contact-people' ); ?></th>
				<th class="manage-column column-image">&nbsp;</th>
				<th class="manage-column column-title" style="text-align:left;white-space:nowrap"><?php _e('Name', 'manager-contacts-page-contact-people' ); ?></th>
				<th class="manage-column column-id" style="text-align:left;white-space:nowrap"><?php _e('ID', 'manager-contacts-page-contact-people' ); ?></th>
				<th class="manage-column column-email" style="text-align:left;white-space:nowrap"><?php _e('Email', 'manager-contacts-page-contact-people' ); ?></th>
				<th class="manage-column column-phone" style="text-align:left;white-space:nowrap"><?php _e('Phone', 'manager-contacts-page-contact-people' ); ?></th>
				<th style="text-align:left" class="manage-column column-location"><?php _e('Location', 'manager-contacts-page-contact-people' ); ?></th>
			...
			if ( is_array($my_contacts) && count($my_contacts) > 0 ) {
			  ...
			  <tr id="recordsArray_<?php echo $value['id']; ?>" class="no-items">
				...
				<td valign="middle" class="column-actions" align="center"><a title="<?php _e('Edit', 'manager-contacts-page-contact-people' ); ?>" href="<?php echo admin_url('admin.php?page=people-contact&action=edit&id='.$value['id'], 'relative');?>"><?php _e('Edit', 'manager-contacts-page-contact-people' ); ?></a> | <a title="<?php _e('Delete', 'manager-contacts-page-contact-people' ); ?>" href="<?php echo admin_url('admin.php?page=people-contact-manager&action=del&id='.$value['id'], 'relative');?>" onclick="if(!confirm('<?php _e('Are you sure delete this profile?', 'manager-contacts-page-contact-people' ); ?>')){return false;}else{return true;}"><?php _e('Delete', 'manager-contacts-page-contact-people' ); ?></a></td>
			  </tr>
			  <?php
				}
			}else{
								?>
			  <tr>
				<td valign="middle" align="center" colspan="9"><?php _e('No Profile', 'manager-contacts-page-contact-people' ); ?></td>
			  </tr>
			  <?php
			}
		?>
